...
class SinistreDimController extends Controller
{
    public function AllSinistreDim()
    {
        ...
        return view('backend.sinistres_dim.all_sinistres_dim', compact('sinistres_dim'));
    }
    ...
    public function FilterSinistreDim(Request $request)
    {
        ...
        return view('backend.sinistres_dim.all_sinistres_dim', compact('sinistres_dim', 'date_debut', 'date_fin', 'dataExists'));
    }
    ...
    public function AddSinistreDim()
    {
        ...
        $charge_compte_sdim = ChargeCompteDim::all();
        $sinistres_dim = SinistreDim::latest()->get();

        return view('backend.sinistres_dim.add_sinistre_dim', compact('branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_sdim'));
    }

    public function ShowSinistreDim($id)
    {
        // Find the production record by ID along with its related data
        $sinistres_dim = SinistreDim::with(['branches_sinistres_at_rd', 'compagnies', 'acte_de_gestion_sinistres_at_rd', 'charge_compte_sinistres_at_rd'])
            ->findOrFail($id);

        // Return the production details view with the related data
        return view('backend.sinistres_dim.show_sinistre', compact('sinistres_dim'));
    }
    ...
    public function StoreSinistreDim(Request $request)
    {
        ...
        return redirect('/all/sinistres_dim')->with('success', 'Production record created successfully');
    }
    ...
    public function EditSinistreDim($id)
    {
        ...
        return view('backend.sinistres_dim.edit_sinistre_dim', compact('sinistres_dim', 'branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_dim'));
    }
    ...
    public function UpdateSinistreDim(Request $request, SinistreDim $sinistres_dim, $id)
    {
        ...
        // Redirect to the index page or another appropriate page
        return redirect('/all/sinistres_dim')->with('success', 'Sinistre Dim record updated successfully');
    }
    ...
    public function DeleteSinistreDim(SinistreDim $sinistres_dim, $id)
    {
        ...
        return redirect('/all/sinistres_dim')->with('success', 'Sinistre Dim deleted successfully');
    }

   // ======= admin sinisters dim functions ======


    public function AdminAllSinistreDim()
    {

        $sinistres_dim = SinistreDim::with('branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_dim')->get();
        return view('backend.sinistres_dim.admin_all_sinistres_dim', compact('sinistres_dim'));
    }

    public function AdminFilterSinistreDim(Request $request)
    {
        $date_debut = $request->input('date_debut');
        $date_fin = $request->input('date_fin');
        ...
        return view('backend.sinistres_dim.admin_all_sinistres_dim', compact('sinistres_dim', 'date_debut', 'date_fin', 'dataExists'));
    }

    public function AdminExportSinistreDim(Request $request)
    {
        $date_debut = $request->date_debut;
        $date_fin = $request->date_fin;
    ...
    public function AdminResetSinistreDimFilter()
    {
        // Fetch all productions without any filtering
        $sinistres_dim = SinistreDim::all();
    ...
    public function AdminAddSinistreDim()
    {
        // Retrieve lists of related models for dropdowns
        $branches_dim = BrancheDim::all();
        $compagnies = Compagnie::all();
        ...
        return view('backend.sinistres_dim.admin_add_sinistre_dim', compact('branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_sdim'));
    }

    public function AdminShowSinistreDim($id)
    {
        // Find the production record by ID along with its related data
        $sinistres_dim = SinistreDim::with(['branches_sinistres_at_rd', 'compagnies', 'acte_de_gestion_sinistres_at_rd', 'charge_compte_sinistres_at_rd'])
            ->findOrFail($id);
        ...
        // Return the production details view with the related data
        return view('backend.sinistres_dim.admin_show_sinistre', compact('sinistres_dim'));
    }

    public function AdminStoreSinistreDim(Request $request)
    {
        // Validate incoming data
        $validatedData = $request->validate([
            'branche_dim_id' => 'required|exists:branches_dim,id',
        ...
        // Redirect to the index page or another appropriate page
        return redirect('/sinistres_dim')->with('success', 'Production record created successfully');
    }




    public function AdminEditSinistreDim($id)
    {
        // Find the production record by ID along with its related data
        $sinistres_dim = SinistreDim::with(['branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_dim'])->findOrFail($id);;
        ...
        return view('backend.sinistres_dim.admin_edit_sinistre_dim', compact('sinistres_dim', 'branches_dim', 'compagnies', 'acte_de_gestion_dim', 'charge_compte_dim'));
    }


    public function AdminUpdateSinistreDim(Request $request, SinistreDim $sinistres_dim, $id)
    {
        $validatedData = $request->validate([
            'branche_dim_id' => 'required|exists:branches_dim,id',
            'compagnie_id' => 'required|exists:compagnies,id',
        ...
        // Redirect to the index page or another appropriate page
        return redirect('/sinistres_dim')->with('success', 'Sinistre Dim record updated successfully');
    }

    public function AdminDeleteSinistreDim(SinistreDim $sinistres_dim, $id)
    {

        SinistreDim::findOrFail($id)->delete();
        return redirect('/sinistres_dim')->with('success', 'Sinistre Dim deleted successfully');
    }
}
