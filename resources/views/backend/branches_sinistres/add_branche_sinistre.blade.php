...
<div class="page-content">
    ...
    <div class="row profile-body">
        ...
        <nav class="page-breadcrumb">
                  <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('all.branches.sinistres')}}" class="btn btn-inverse-secondary">Toute les branche sinistres</a></li>
            ...
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Ajouter branche Sinistres</h6>
