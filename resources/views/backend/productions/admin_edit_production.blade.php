    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{route('productions')}}" class="btn btn-inverse-secondary">Toute les Productions</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{route('ajouter.production')}}" class="btn btn-inverse-secondary">Ajouter Production</a></li>
                </ol>
            </nav>
            <div class="row">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{route('admin.update.production',['id' => $production->id])}}" class="forms-sample" enctype="multipart/form-data" >
                            @csrf
