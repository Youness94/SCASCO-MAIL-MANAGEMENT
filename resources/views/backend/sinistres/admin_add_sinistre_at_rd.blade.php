...
<div class="page-content">
    ...
    <div class="row profile-body">
        ...
        <nav class="page-breadcrumb">
                  <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href="{{route('sinistres.at.rd')}}" class="btn btn-inverse-secondary">Toute les sinistres</a></li>
					...
					<div class="col-md-12 grid-margin">
						<div class="card">
							<div class="card-body">
								...
								<form method="POST" action="{{route('admin.store.sinistre.at.rd')}}" class="forms-sample" enctype="multipart/form-data">
                               				 @csrf
									<div class="row mb-3">
										<div class="col-md-4">
