...
<div class="page-content">
  ...
  <nav class="page-breadcrumb">
    <ol class="breadcrumb">
      <li class="breadcrumb-item"><a href="{{route('admin.add.sinistre.at.rd')}}" class="btn btn-inverse-secondary">Ajouetr Sinistre</a></li>
    </ol>
  </nav>
  ...
  <div class="row">
    <div class="col-md-12 grid-margin stretch-card">
      <div class="card">
        <div class="card-body">
          <form method="GET" action="/filter_sinistres_at_rd">
          ...
          <div class="d-flex align-items-center flex-wrap text-nowrap">
            ...
            <a href="/reinitialiser_sinistre_at_rd" class="btn btn-outline-warning btn-icon-text me-2 mb-2 mb-md-0">
              <!-- <i class="btn-icon-prepend" data-feather="printer"></i> -->
              Réinitialiser
            </a>
            @if(isset($date_debut) && isset($date_fin) && $dataExists)
            <a href="{{ route('exporter_filtre_sinistres_at_rd', ['date_debut' => $date_debut, 'date_fin' => $date_fin]) }}" class="btn btn-success btn-icon-text mb-2 mb-md-0">
            ...
            <table id="dataTableExample" class="table table-striped">
              ...
              @foreach ($sinistres as $key => $item)
                <tr>
                  ...
                  <td>
                    <a href="{{route('admin.edit.sinistre.at.rd', $item->id)}}" class="btn btn-inverse-warning">Edit</a>
                  </td>>
                </tr>
                @endforeach
