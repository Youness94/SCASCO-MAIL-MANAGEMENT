    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('all.sinistres.at.rd') }}" class="btn btn-inverse-secondary">Les sinistres AT & RD</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('add.sinistre.at.rd') }}" class="btn btn-inverse-secondary">Ajouter sinistre</a></li>
                </ol>
            </nav>
            <div class="row">
                <div class="card">
