    ...
    <div class="row profile-body">
        ...
        <div class="col-md-12 col-xl-12 middle-wrapper">
            <nav class="page-breadcrumb">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ route('all.sinistres.dim') }}" class="btn btn-inverse-secondary">Toute les Sinistres</a></li>
                    <li class="breadcrumb-item active" aria-current="page"><a href="{{ route('add.sinistre.dim') }}" class="btn btn-inverse-secondary">Ajouter Sinistres</a></li>
                </ol>
            </nav>
            <div class="row">
                <div class="card">
