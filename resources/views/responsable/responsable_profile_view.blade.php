                  ...
                  <div class="card rounded">
                        <div class="card-body">
                              <div class="d-flex align-items-center justify-content-between mb-2">
                                    ...
                                    <div>
                                          <img class="wd-100 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/responsable_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="profile">
                              ...
                              <div class="card-body">
                                    ...
                                    <form method="POST" action="{{route('responsable.profile.store')}}" class="forms-sample" enctype="multipart/form-data">
                                          ...
                                          <!-- <div class="mb-3">
                                                ...
                                                <input type="password" name="password" class="form-control" id="exampleInputPassword1" autocomplete="off" placeholder="Password" value="{{$profileData->password}}">
                                          </div> -->
                                          <!-- <div class="mb-3">
                                                <label for="exampleInputUsername1" class="form-label">Role</label>
                                                <input type="text" name="image" class="form-control" id="exampleInputUsername1" autocomplete="off" placeholder="Role" value="{{$profileData->role}}">
                                          </div>
                                          <div class="form-check mb-2">
                                                <input type="checkbox" name="status" class="form-check-input" id="checkChecked" checked value="{{$profileData->status}}">
								...
								<label class="form-label" for="formFile"></label>
                                                <img id= 'showImage' class="wd-80 rounded-circle" src="{{ (!empty($profileData->photo)) ? url('upload/responsable_images/'.$profileData->photo) : url('upload/no_image.jpg')}}" alt="profile">
							</div>
